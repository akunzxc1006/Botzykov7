...
let view = await fetch(`https://api.lolhuman.xyz/api/tiktok?apikey=GanzKimochi1994}`)
...
conn.sendHydrated2(m.chat, `Done @${m.sender.split(`@`)[0]}`, done, url, 'https://instagram.com/al.0fficial_/', 'ɪ ɴ s ᴛ ᴀ ɢ ʀ ᴀ ᴍ', 'https://youtube.com/@aldiganzoffc', 'ʏ ᴏ ᴜ ᴛ ᴜ ʙ ᴇ', [['Donasi', `.donasi`], ['Audio', `.tiktokmp3 ${args[0]}`]], m)
} catch (e) {
